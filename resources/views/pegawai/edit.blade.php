            ...
            <h5 class="card-title fw-semibold mb-4">Data Pegawai</h5>
                ...
                <form action="{{ route('pegawai.update', $pegawai->id_pegawai) }}" method="post">
                    ...
                    <fieldset disabled>
                        ...
                        <input class="form-control form-control-solid" id="kode_pegawai_tampil" name="kode_pegawai_tampil" type="text" placeholder="Contoh: PR-001" value="{{$pegawai->kode_pegawai}}" readonly></div>
                    </fieldset>
                    ...
                    <input class="form-control form-control-solid" id="nama_pegawai" name="nama_pegawai" type="text" placeholder="Contoh: Melvin" value="{{$pegawai->nama_pegawai}}">
                    </div>
